/**
 * Montagem do app Express -- rotas, CORS e validação.
 *
 * Separado de `index.ts` para poder ser importado sem subir servidor: o
 * `app.listen` no escopo do módulo fazia com que qualquer `import` abrisse a
 * porta 3000 e ligasse a ingestão, o que impedia testar as rotas.
 */
